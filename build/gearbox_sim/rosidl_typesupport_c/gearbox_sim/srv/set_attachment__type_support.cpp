...
static const _SetAttachment_Request_type_support_symbol_names_t _SetAttachment_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gearbox_sim, srv, SetAttachment_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gearbox_sim, srv, SetAttachment_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gearbox_sim, srv, SetAttachment_Request)() {
  return &::gearbox_sim::srv::rosidl_typesupport_c::SetAttachment_Request_message_type_support_handle;
}
...
static const _SetAttachment_Response_type_support_symbol_names_t _SetAttachment_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gearbox_sim, srv, SetAttachment_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gearbox_sim, srv, SetAttachment_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gearbox_sim, srv, SetAttachment_Response)() {
  return &::gearbox_sim::srv::rosidl_typesupport_c::SetAttachment_Response_message_type_support_handle;
}
...
static const _SetAttachment_Event_type_support_symbol_names_t _SetAttachment_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gearbox_sim, srv, SetAttachment_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gearbox_sim, srv, SetAttachment_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gearbox_sim, srv, SetAttachment_Event)() {
  return &::gearbox_sim::srv::rosidl_typesupport_c::SetAttachment_Event_message_type_support_handle;
}
...
static const _SetAttachment_type_support_symbol_names_t _SetAttachment_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gearbox_sim, srv, SetAttachment)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gearbox_sim, srv, SetAttachment)),
  }
};
...
static const rosidl_service_type_support_t SetAttachment_service_type_support_handle = {
  ...
  &SetAttachment_Request_message_type_support_handle,
  &SetAttachment_Response_message_type_support_handle,
  &SetAttachment_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, gearbox_sim, srv, SetAttachment)() {
  return &::gearbox_sim::srv::rosidl_typesupport_c::SetAttachment_service_type_support_handle;
}
